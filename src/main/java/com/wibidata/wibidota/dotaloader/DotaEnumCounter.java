 ...
 */
public class DotaEnumCounter extends Configured implements Tool {
  private static final Logger LOG = LoggerFactory.getLogger(DotaEnumCounter.class);
  ...
  // Interval to subdived the results by
  ...
  public static void main(String args[]) throws Exception {
    ...
    int res = ToolRunner.run(conf, new DotaEnumCounter(), args);
    System.exit(res);
  }
